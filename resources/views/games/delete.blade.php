    ...
    <div class="d-flex justify-content-center w-100">
        <div class="w-75">
            <div class="alert alert-danger">
                <p>Estas a putno de eliminar el juego <b>"{{ $game->name}}"</b></p>
                <p>¿Quieres eliminar el juego?</p>

                <form action="{{route('games.destroy',['id'=>$game->game_id])}}"
                class="mb-3"
                method="post">
                    @csrf
                    @method('DELETE')
                    ...
                    <button type="submit" class="btn btn-danger">Quiero eliminar "{{ $game->name}}" </button>
                </form>
            </div>
